...
public class ShapeFactory {
    ...
    public static <T extends Shape> T create(Class<T> type, PVector position, Object... args) {
        Shape shape = create(type, args);
        shape.transform().setPosition(position);
        return type.cast(shape);
    }

    public static <T extends Shape> T create(Class<T> type, Transform parent, PVector localPosition,
            Object... args) {
        Shape shape = create(type, args);
    ...
    public static <T extends Shape> T create(Class<T> type, PVector position, float rotation,
            PVector scale, Object... args) {
        Shape shape = create(type, args);
        shape.transform().setPosition(position);
